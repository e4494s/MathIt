...
function makeQuestionIntegral() {
    ...
    return `What is the integral of \\(${questionFunctionLatex}\\)?`;
}
...
function checkAnswerIntegral(answer1) {
    ...
    skillLevel--;
    correctTxt.innerHTML = "You got the answer incorrect.<br>Here is the correct answer: ";
    if (der === 1){
...
function makeQuestionDerivative() {
    ...
    return `What is the derivative of \\(${questionFunctionLatex}\\)?`;
}
function checkAnswerDerivative(answer) {
    ...
    correctTxt.style.color = "red";
    correctTxt.innerText = "You got the answer incorrect. Here is the correct answer: ";
    if (der === 1){
        correctTxt.style.color = "red";
        correctTxt.innerText =`The power rule states that if \\(n\\) is a rational number, then the function \\(f(x) = x^n\\) is differentiable and\n
